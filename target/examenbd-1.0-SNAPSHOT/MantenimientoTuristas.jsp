...
<head>
    <meta charset="UTF-8">
    <title>Mantenimiento de Turistas</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/all.min.css"> <!-- Font Awesome -->
    <style>
        /* Estilos generales */
        body {
            font-family: 'Arial', sans-serif;
            background-image: url('images/image8.jpg'); /* Cambia la imagen de fondo si lo deseas */
        ...
        .action-btn {
            background-color: #2ecc71; /* Verde para botones */
            color: white;
...
<body>
    ...
    <!-- Menú superior -->
    <header>
        <h1>Mantenimiento de Turistas</h1>
    </header>

    <div class="container">
        <!-- Botones de acción con íconos -->
        <a href="MostrarTablaTurista.jsp" class="action-btn">
            <i class="fas fa-table"></i> Mostrar Tabla
        </a>
        <a href="InsertarTurista.jsp" class="action-btn">
            <i class="fas fa-user-plus"></i> Insertar
        </a>
        <a href="Modificar.jsp" class="action-btn">
            <i class="fas fa-user-edit"></i> Modificar
        </a>
        <a href="EliminarTurista.jsp" class="action-btn">
